      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-500 mb-6">SERVIQ charges a flat <strong className="text-brand-electricBlue">25% commission</strong> on all completed jobs. This fee helps us maintain the platform, provide customer support, and ensure our Trust Wallet security system runs smoothly.</p>
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Partners take home <strong className="text-green-500">75%</strong> of every job they complete successfully.</p>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-white dark:bg-[#0f172a] rounded-xl border border-gray-100 dark:border-gray-800">
                ...
                <span className="text-green-500 font-bold flex items-center gap-1"><ArrowRight size={14}/> Partner gets ₹112.50</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-white dark:bg-[#0f172a] rounded-xl border border-gray-100 dark:border-gray-800">
                <span className="text-brand-black dark:text-white font-bold">₹300 Job</span>
                <span className="text-green-500 font-bold flex items-center gap-1"><ArrowRight size={14}/> Partner gets ₹225.00</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-white dark:bg-[#0f172a] rounded-xl border border-gray-100 dark:border-gray-800">
                <span className="text-brand-black dark:text-white font-bold">₹400 Job</span>
                <span className="text-green-500 font-bold flex items-center gap-1"><ArrowRight size={14}/> Partner gets ₹300.00</span>
              </div>
            </div>
          </motion.div>
        </div>
