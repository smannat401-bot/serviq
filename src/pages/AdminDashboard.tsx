...
import { IndianRupee, Activity, CheckCircle, XCircle, AlertCircle, ShieldAlert, LogOut } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    if (!user._id) {
      ...
      window.location.href = user.role === 'worker' ? '/worker-dashboard' : '/client-dashboard';
    }
  }, [user]);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B1120] pt-24 pb-12">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-brand-black dark:text-white">Admin Dashboard</h1>
          <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-sm text-gray-500">From 18% Trust Wallet commissions.</p>
          </motion.div>
