    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#060a14] py-16 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-brand-black dark:text-white mb-4">Why SERVIQ was created</h2>
          ...
          <p className="text-gray-500 leading-relaxed">
            SERVIQ was created to solve this double-sided problem. We provide a premium, structured platform where professionals are respected and paid fairly, and users receive guaranteed, high-quality Service.
          </p>
        </motion.div>
