      ...
      <div className="relative flex overflow-hidden">
        ...
        >
          {displayTestimonials.map((testimonial, index) => (
            <div
              key={index}
              className="w-[450px] shrink-0 glass-card p-10 whitespace-normal border-gray-100 dark:border-white/10"
            >
              ...
              <div className="flex items-center gap-5">
                ...
                />
                <div>
                  <h4 className="font-bold text-brand-black dark:text-white text-lg leading-tight">{testimonial.author}</h4>
                  <p className="text-sm text-brand-electricBlue font-bold uppercase tracking-widest">{testimonial.role}</p>
                </div>
              </div>
            </div>
          ))}
