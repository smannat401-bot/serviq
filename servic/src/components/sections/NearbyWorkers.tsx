        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {workers.map((worker, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#0f172a] rounded-3xl p-5 border border-gray-100 dark:border-gray-800 hover:shadow-xl hover:border-brand-electricBlue/30 transition-all group"
            >
